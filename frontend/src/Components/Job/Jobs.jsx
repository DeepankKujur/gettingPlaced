...
const Jobs = () => {
  ...
  return (
    <div className="relative w-full min-h-screen px-4 sm:px-6 lg:px-8 py-10">
      ...
      {/* Heading */}
      <h3 className="text-4xl text-white font-bold mb-10 text-center">
        All Available Jobs
      </h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        {filteredJobs?.map((element) => (
          ...
          >
            <div>
              <p className="text-xl font-semibold text-amber-400 mb-2 tracking-wide uppercase">
                {element.company}
              </p>
              <p className="text-2xl font-bold text-white mb-1">{element.title}</p>
              <p className="text-lg text-purple-300 mb-1">{element.category}</p>
